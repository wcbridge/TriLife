...
const ProjDescription = props => (
  <div className="section_description">
    ...
    <br />
    <p>TriLife will calculate the appropriate percentages for each category and allow users to allocate those hours for each category to a calendar in order to block off time to achieve their goals without overextending themselves. </p>
    <br />
    <p> Click this <i className="has-text-info fas fa-info-circle"></i> to view notes.</p>
  </div>
);
